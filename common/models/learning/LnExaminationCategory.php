...
/**
 * This is the model class for table "{{%ln_examination_category}}".
 *
 * @property string $kid
 ...
 */
class LnExaminationCategory extends BaseActiveRecord
{
    /**
     * @inheritdoc
     */
    ...
    {
        return '{{%ln_examination_category}}';
    }
    ...
    {
        return $this->hasMany(LnExamination::className(), ['category_id' => 'kid'])
