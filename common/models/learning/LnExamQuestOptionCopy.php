...
/**
 * This is the model class for table "{{%ln_exam_quest_option_copy}}".
 *
 * @property string $kid
 * @property string $examination_question_copy_id
 * @property string $examination_question_option_id
 ...
 */
class LnExamQuestOptionCopy extends BaseActiveRecord
{
    /**
     * @inheritdoc
     */
    ...
    {
        return '{{%ln_exam_quest_option_copy}}';
    }
    ...
    {
        return [
            [['examination_question_copy_id', 'examination_question_option_id', 'option_title'], 'required'],
            [['option_title', 'option_description'], 'string'],
            [['default_score'], 'number'],
            [['sequence_number', 'version', 'created_at', 'updated_at'], 'integer'],
            [['kid', 'examination_question_copy_id', 'examination_question_option_id', 'option_version', 'created_by', 'updated_by'], 'string', 'max' => 50],
    ...
    public function attributeLabels()
    {
        return [
            ...
            'examination_question_option_id' => 'Examination Question Option ID',
