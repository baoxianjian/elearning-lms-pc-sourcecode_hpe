...
/**
 * This is the model class for table "{{%rp_st_face_course_comp}}".
 *
 * @property string $kid
 ...
 * @property integer not_qualify
 * @property string not_qualify_rate
 * @property integer certification
 * @property string certification_rate
 ...
 */
class RpStFaceCourseComp extends BaseActiveRecord
{
	/**1.汇报经理,2.域,3.企业*/
