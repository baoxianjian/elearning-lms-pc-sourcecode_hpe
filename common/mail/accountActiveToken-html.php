...
$resetLink = Yii::$app->urlManager->createAbsoluteUrl(['site/signup-active', 'token' => $user->account_active_token]);
            ...
            <table border="0" cellpadding="0" width="100%" style="width:100.0%">
                <tr style="height:80pt">
                    <td valign="top" style="padding:.75pt .75pt .75pt .75pt;">
                        ...
                        <p>
                            <span style="font-size:18.0pt;">激活账号<br></span>
                        </p>
                    </td>
                </tr>
                <tr>
                    <td valign="top" style="padding:.75pt .75pt .75pt .75pt">
                        ...
                        <p>
                            <span style="font-size:10.0pt;">根据下面的流程，您可以方便的激活您的系统账号：</span>
                        </p>
                        <table border="0" cellspacing="6" cellpadding="0" width="90%" style='width:90%'>
                            <tr>
                                ...
                                <td width="814" style='width:610.5pt;background:#F0F0F0;padding:1.5pt 1.5pt 1.5pt 1.5pt'>
                                    <p>
                                        <span style='font-size:10.0pt;font-family:"Arial","sans-serif"'>点击如下链接地址可以登录至账号激活页面：
                                            <br>
                            ...
                            <tr>
                                ...
                                <td width="814" style='width:610.5pt;background:#F0F0F0;padding:1.5pt 1.5pt 1.5pt 1.5pt'>
                                    <p>
                                        <span style='font-size:10.0pt;font-family:"Arial","sans-serif"'>至此，您的账号已经激活完成，请重新登录即可<br></span>
                                    </p>
                                </td>
                            </tr>
                        </table>
