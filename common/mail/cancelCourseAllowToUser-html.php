            ...
            <table border="0" cellpadding="0" width="100%" style="width:100.0%">
                ...
                <tr>
                    <td valign="top" style="padding:.75pt .75pt .75pt .75pt">
                        ...
                        <p>
                            <span style="font-size:10.0pt;">您报名的课程《<a href="<?= Yii::$app->urlManager->createAbsoluteUrl(['resource/course/view', 'id' => $course->kid, 'from' => 'mail']) ?>"><?=$course->course_name?></a>》，请假申请已经审批通过。</span>
                        </p>
                    </td>
                </tr>
            </table>
