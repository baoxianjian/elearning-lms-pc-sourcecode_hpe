...
?>
 ...
 <a  onclick="closeFun()" class="btn btn-sm pull-right cancelBtn">关闭</a>
                          <div class="Result_noName_vote">
                            <h4><?=$results['answer_type'] ?>结果</h4>
                            <hr>
                            
                            <? foreach ($results['question'] as $ques): ?>
                             <h4><?=$ques['question_title'] ?></h4>
  ...
  function closeFun( ){
	  ...
	  $('#course_play_survey_result_id').addClass('hide');
