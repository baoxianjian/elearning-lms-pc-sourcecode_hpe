	...
	$.jstree.core.prototype = {
		...
		redraw_node : function (node, deep, is_callback, force_render) {
			...
			if (obj.state.deleted){
				var _del_span = d.createElement('span');
				_del_span.setAttribute('data-key', obj.id);
				_del_span.className = 'delete_tree_node';
				_del_span.textContent = LANG.TREE_NODE_DELETE;
				node.appendChild(_del_span);
			}

			if (obj.state.edited){
				var _edit_span = d.createElement('span');
				_edit_span.setAttribute('data-key', obj.id);
				_edit_span.className = 'edit_tree_node';
				_edit_span.textContent = LANG.TREE_NODE_EDIT;
				node.appendChild(_edit_span);
			}
