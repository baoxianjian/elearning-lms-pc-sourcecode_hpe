...
<div class="filterBtn pull-right" style="width:50%;" id="minelist">
    <a href="#" class="btnFilter" data-num="0" id="questionmine" ><?=Yii::t('frontend', 'i_propose')?> </a>
    <a href="#" class="btnFilter activeBtn" data-num="1" id="icare" ><?=Yii::t('frontend', 'i_follow')?></a>
...
<div class="questionLine" id="questionismine">
    ...
    <div class="questionBlock" id="<?=$v['kid']?>" type="1">
        <h3>
