                ...
                <ul class="nav navbar-nav pull-right">
                    ...
                    <li id="msgMenu" class="active">
                        ...
                        <ul class="dropdown-menu dropdown-menu-right" role="menu">
                            ...
                            <li><a href="javascript:void(0);" onclick="showPopMsg('<?= Yii::$app->urlManager->createUrl('common/pop-message-news') ?>')" class="pull-left"><?= Yii::t('frontend', 'tab_btn_news') ?></a></a><span class="badge pull-right">0</span></li>
...
<div class="ui modal" id="systemSetting">
    <div class="header">
        ...
        <h4 class="modal-title" id="myModalLabel"><?= Yii::t('system', 'frontend_name') ?></h4>
    </div>
    <div class="content">
...
<script type="text/javascript">
    ...
    function scoreEffect(change) {
        ...
        */
        scoreEffect1('<?=Yii::t('common', 'point')?>',20,'<?=Yii::t('frontend','registered_face_to_face_courses')?>',600000);
    ...
    function scorePointEffect(change, cAction, newScore) {
       ...
       //  myJson = [{"point":"1"},{"password":"1111"}] ;
         scoreEffect1('<?=Yii::t('common', 'point')?>',change,cAction,newScore);
    }
