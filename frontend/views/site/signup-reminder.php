                    ...
                    <div class="row">
                        <div class="site-signup">
                            ...
                            <?php if (!empty($model)) {?>
                                ...
                                <p style="text-indent:30px"><?=Yii::t('system','login_{value}_for_activation',['value'=>$model->email])?></p>
                            <? } else { ?>
                                <?=Yii::t('frontend','invalid_activation_code')?>
                            <? }?>
                            <p style="margin-top:80px; text-align:right;"><?=Yii::t('frontend','from_text')?>：<?=Yii::t('frontend','frontend_manager')?></p>
                        </div>
                    </div>
                </div>
            </div>
