...
?>
              ...
              <div class=" panel-default scoreList">
                <div class="panel-body">
                  ...
                  <div class="centerBtnArea">
                    <span><?=Yii::t('frontend', 'exam_shitizongshi')?>: <?=$result['examination_question_number'] ?><?=Yii::t('frontend', 'exam_ti')?></span>
                  ...
                  <div class="col-md-12 col-sm-12 centerBtnArea" style="margin-top: 20px;">
                    <a href="javascript:void(0)" id="new_exam_final_submit_id" class="btn btn-success btn-sm centerBtn" style="width:40%;"><?=Yii::t('frontend', 'exam_bianjibingfanhuiliebiao')?></a>
                  </div>
                </div>
              </div>
            </div>
   ...
   $(function(){
      ...
      $("#new_exam_final_submit_id").click(function(){
    	  var url="<?=Yii::$app->urlManager->createUrl(['exam-paper-manage/new-exam-paper-final-submit'])?>";
