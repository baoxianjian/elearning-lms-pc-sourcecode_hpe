   ...
   <script type="text/javascript">
         ...
         function query(){
        	 ...
        	 $.ajax({   	
        	   ...
        	   async: false,
        	   type: "POST",
			   url: "<?=Url::toRoute(['exam-paper-manage/view-exam-paper-data',])?>",
			   data: {id:"<?=$id?>"},
		   ...
		   var lists_arrs=_.sortBy(msg.result.question, function(num){      
      	 ...
      	 // var lists_arrs=msg.result.question;
      	  ...
      	  console.log(lists_arrs);

       	  if(lists_arrs.length==0){
       		  $("#pre_first_survey_row").append("<?=Yii::t('frontend', 'exam_note_wushitishumu')?>");
       		  return;
          }
            ...
            var preview_num_show=1;
			   ...
			   for(var i=0;i<lists_arrs.length;i++){
				   ...
				   if(lists_tmp.examination_question_type=='3'){
					   var lists=[];
					  ...
					  if(first_pagination_code==i){
				   ...
				   }else if(lists_tmp.examination_question_type=='1'){
					   ...
					   preview_num_show++;
				   }else if(lists_tmp.examination_question_type=='0'){
       ...
       <div class="row questionGroup_quest">
                     <div class="col-md-12 col-sm-12">
	                      <div class="form-group form-group-sm">
	                        ...
	                        <label class="col-sm-12 control-label"><%=item.preview_num_show%>.【<?=Yii::t('common', 'question_radio')?>】 <?=Yii::t('frontend', 'question')?>:<%=item.title%> ( )</label>
       ...
       <div class="row questionGroup_quest">
                     <div class="col-md-12 col-sm-12">
	                      <div class="form-group form-group-sm">
	                        ...
	                        <label class="col-sm-12 control-label"><%=item.preview_num_show%>.【<?=Yii::t('common', 'question_checkbox')?>】 <?=Yii::t('frontend', 'question')?>:<%=item.title%> ( )</label>
...
<%_.each(data.datas, function(item) {%>
                    ...
                    <div class=" centerBtnArea">
                      ...
                      <a  class="btn btn-sm btn-success centerBtn" style="width:20%" onClick="next_page_fun('<%=item.id%>','<%=item.nid%>')"><?= Yii::t('frontend', 'next_step') ?></a>
                     </div>
 <%});%>
    </script> 
