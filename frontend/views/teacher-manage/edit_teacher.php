...
<!-- 新建教师信息的弹出窗口 -->
        ...
        <div class="header">
          ...
          <h4 class="modal-title" id="myModalLabel"><?= Yii::t('frontend', 'modify_teacher') ?></h4>
        </div>
        <div class="content">
                ...
                <div class=" panel-default scoreList">
                  <div class="panel-body">
                    ...
                    <form id="new_teacher_form">
                      ...
                      <input type="hidden" id="t_company_id"  value="<?=$uinfo['company_id'] ?>"/>
                        <input type="hidden" id="t_user_id"  value="<?=$uinfo['user_id'] ?>"/>
                         <input type="hidden" id="kid"  value="<?=$teacher['kid'] ?>"/>
                         
                            <input type="hidden" id="teacher_thumb_url" value="<?=$teacher['teacher_thumb_url'] ?>"/>
                            
               
          <div class="uploadFileTablePW row" style="border: 1px solid #eee;padding: 10px;margin-left: 15%;width: 70%;">
            <div class="col-md-12 col-sm-12">
                <div class="col-md-6 col-sm-6"><img id="img_thumb" src="<?=$teacher['teacher_thumb_url'] ?>" /></div>
        ...
        <div class="text-info"></div>
                      ...
                      <div class="row">
                        ...
                        <div class="col-md-6 col-sm-6">
                          <div class="form-group form-group-sm">
                            ...
                            <div class="col-sm-9">
                              <input value="<?=$uinfo['user_name'] ?>" data-alert="<?= Yii::t('frontend', '{value}_not_null',['value'=>Yii::t('common','time_validity')]) ?>" data-delay="1" data-mode="COMMON" id="teacher_to_user_id" class="form-control changeTeacher2" type="text" style="width: 79%;margin-right: 1%;" placeholder="<?= Yii::t('frontend', 'tip_for_teacher_account') ?>">
                      ...
                      <div class="row">
                        <div class="col-md-6 col-sm-6">
                          <div class="form-group form-group-sm">
                            ...
                            <div class="col-sm-9">
                              <input value="<?=$teacher['teacher_name'] ?>"  data-mode="COMMON" data-condition="^\S{1,25}$" data-alert="<?= Yii::t('frontend', 'name_not_null_or_not_beyond_25') ?>" class="form-control" type="text" name="teacher_name" id="teacher_name_id" >
                      ...
                      <div class="row">
                        <div class="col-md-6 col-sm-6">
                          <div class="form-group form-group-sm">
                            ...
                            <div class="col-sm-9">
                              <input value="<?=$teacher['teacher_nick'] ?>" data-mode="COMMON" data-condition="^.{0,25}$" data-alert="<?=Yii::t('frontend', '{value}_limit_25_word',['value'=>Yii::t('common', 'nick_name') ]) ?>" class="form-control" type="text" name="teacher_nick" id="teacher_nick_id" >
                            </div>
                          </div>
                        </div>
                        ...
                        <div class="col-md-6 col-sm-6">
                          <div class="form-group form-group-sm">
                            ...
                            <div class="col-sm-9">
                              <input   value="<?=$teacher['graduate_school'] ?>" data-mode="COMMON" data-condition="^.{0,125}$" data-alert="毕业院校超过125" class="form-control" type="text" name="graduate_school" id="graduate_school_id" >
                            </div>
                          </div>
                        </div>
                        -->
                      ...
                      <div class="row">
                            ...
                            <div class="col-sm-9">
                              ...
                              <div class="form-group field-courseservice-course_type">
                                <select class="form-control" id="gender_id">
                                  <option value="male" <?php if($teacher['gender']=='male'){ echo"selected"; } ?> ><?= Yii::t('common', 'gender_male') ?></option>
                                  <option value="female" <?php if($teacher['gender']=='female'){ echo"selected"; } ?> ><?= Yii::t('common', 'gender_female') ?></option>
                                </select>
                              </div>
                        ...
                        <div class="col-md-6 col-sm-6">
                          <div class="form-group form-group-sm">
                            ...
                            <div class="col-sm-9">
                              <input value="<?=$teacher['teach_year'] ?>" data-alert="<?= Yii::t('frontend', '{value}_not_null',['value'=>Yii::t('common','time_validity')]) ?>" data-delay="1" data-mode="COMMON" class="form-control" type="text" name="teach_year" id="teach_year_id" placeholder="15">
                            </div>
                          </div>
                        </div>
                      </div>
                      <div class="row">
                        <div class="col-md-6 col-sm-6">
                          <div class="form-group form-group-sm">
                            ...
                            <div class="col-sm-9">
                              <input value="<?=$teacher['birthday'] ?>" data-range=",<?=$data_range ?>" readonly="readonly" data-mode="COMMON" data-condition="required" data-alert="<?= Yii::t('frontend', '{value}_not_null',['value'=>Yii::t('common','birthday')]) ?>" class="form-control" type="text" id="birthday_id" name="birthday" data-type="rili" placeholder="yyyy-mm-dd">
                            </div>
                          </div>
                        </div>
                        <div class="col-md-6 col-sm-6">
                          <div class="form-group form-group-sm">
                            ...
                            <div class="col-sm-9">
                              <input value="<?=$teacher['teach_domain'] ?>" data-mode="COMMON" data-condition="^.{0,125}$" data-alert="<?=Yii::t('frontend', '{value}_limit_125_word',['value'=>Yii::t('common', 'teach_domain') ]) ?>" class="form-control" type="text" name="teach_domain" id="teach_domain_id" >
                            </div>
                          </div>
                        </div>
                      </div>
                      <div class="row">
                        <div class="col-md-6 col-sm-6">
                          <div class="form-group form-group-sm">
                            ...
                            <div class="col-sm-9">
                              <input value="<?=$teacher['mobile_no'] ?>" data-alert="<?= Yii::t('frontend', '{value}_not_null',['value'=>Yii::t('common','time_validity')]) ?>" data-delay="1" data-mode="COMMON" class="form-control" type="text" name="mobile_no" id="mobile_no_id" >
                            </div>
                          </div>
                        </div>
                        <div class="col-md-6 col-sm-6">
                          <div class="form-group form-group-sm">
                            ...
                            <div class="col-sm-9">
                              <input value="<?=$teacher['home_phone_no'] ?>" data-alert="<?= Yii::t('frontend', '{value}_not_null',['value'=>Yii::t('common','time_validity')]) ?>" data-delay="1" data-mode="COMMON" class="form-control" type="text" name="home_phone_no" id="home_phone_no_id" >
                            </div>
                          </div>
                        </div>
                      </div>
                      ...
                      -->
                       ...
                       <div class="col-md-6 col-sm-6">
                          <div class="form-group form-group-sm">
                            ...
                            <div class="col-sm-9">
                              <input value="<?=$teacher['teacher_title'] ?>" data-mode="COMMON" data-condition="^.{0,125}$" data-alert="<?=Yii::t('frontend', '{value}_limit_125_word',['value'=>Yii::t('common', 'teacher_title') ]) ?>" class="form-control" type="text" name="teacher_title" id="teacher_title_id" >
                          </div>
                          </div>
                        </div>
                        ...
                        <div class="col-md-12 col-sm-12">
                          <div class="form-group form-group-sm">
                            ...
                            <div class="col-sm-10" style="width:88%">
                              <textarea id="description"><?=$teacher['description'] ?></textarea>
                            </div>
                          </div>
                        </div>
                      </div>
                    ...
                    <div id="n_b_teacher_show_div" class="infoBlock teacher_EM2">
                      ...
                      <div class="row">
                        <div class="col-md-6 col-sm-6">
                          <div class="form-group form-group-sm">
                            ...
                            <div class="col-sm-9">
                              <input value="<?=$uinfo['company_name'] ?>" readonly="readonly" class="form-control" type="text" id="company_id" placeholder="<?= Yii::t('frontend', 'business_name') ?>">
                            </div>
                          </div>
                        </div>
                        <div class="col-md-6 col-sm-6">
                          <div class="form-group form-group-sm">
                            ...
                            <div class="col-sm-9">
                              <input value="<?=$uinfo['domain_name'] ?>" readonly="readonly" class="form-control" type="text" id="domain_id" placeholder="<?= Yii::t('frontend', 'train_manage_domain') ?>">
                            </div>
                          </div>
                        </div>
                      </div>
                      <div class="row">
                        <div class="col-md-6 col-sm-6">
                          <div class="form-group form-group-sm">
                            ...
                            <div class="col-sm-9">
                              <input value="<?=$uinfo['orgnization_name'] ?>" readonly="readonly" class="form-control" type="text" id="orgnization_id" placeholder="<?= Yii::t('frontend', 'train_partment') ?>">
                            </div>
                          </div>
                        </div>
                        <div class="col-md-6 col-sm-6">
                          <div class="form-group form-group-sm">
                            ...
                            <div class="col-sm-9">
                              <input value="<?=$uinfo['position_name'] ?>" readonly="readonly" class="form-control" type="text" id="position_id" placeholder="<?= Yii::t('frontend', 'train_manager') ?>">
                            </div>
                          </div>
                        </div>
                      </div>
                      <div class="row">
                        <div class="col-md-6 col-sm-6">
                          <div class="form-group form-group-sm">
                            ...
                            <div class="col-sm-9">
                              <input value="<?=$uinfo['reporting_manager'] ?>" readonly="readonly" class="form-control" type="text" id="reporting_manager_id" placeholder="">
                            </div>
                          </div>
                        </div>
                        <div class="col-md-6 col-sm-6">
                     ...
                     <div class="centerBtnArea">
                      <a href="#" id="btn_save_teacher" class="btn btn-success btn-sm centerBtn" style="width:20%"><?= Yii::t('frontend', 'modify') ?></a>
                    </div>
   ...
   $(function(){
       ...
       $("#teacher_syn_from_user").click(function(){
           ...
           if($.trim($("#teacher_to_user_id").val())!=""){
               $.get("<?=Url::toRoute(['teacher-manage/syn-user'])?>",{user_name:$.trim($("#teacher_to_user_id").val()),tid:$("#kid").val()},function(data){
       ...
       $("#btn_save_teacher").click(function(){
    	   ...
    	   save_new_teacher("<?=Url::toRoute(['teacher-manage/update-teacher',])?>");
...
//
   ...
   function getUser()
   {
       ...
       if($.trim($("#teacher_to_user_id").val())!=""){
           $.get("<?=Url::toRoute(['teacher-manage/get-user'])?>",{user_name:$.trim($("#teacher_to_user_id").val()),tid:$("#kid").val()},function(data){
               console.log(data.result);
...
<script>
    ...
    function showSynButton(teacherType)
    {
        ...
        setTimeout(function (){app.refreshAlert("#edit_teacher");}, 0);
    }
