        ...
        <div class="content">
                ...
                <div class="panel-body">
                  <div class="infoBlock">
                    <div class="row questionGroup_quest">
                      <p><?= Yii::t('common', 'time_validity') ?>：<?=$result['start_at'] ?>-<?=$result['end_at'] ?></p>
                      <h4><?=$result['title'] ?></h4>
                     <p style="text-align:left"><?= Yii::t('frontend', 'brief') ?>:<?=$result['description'] ?> </p>
                    </div>
                    ...
                    <div class=" centerBtnArea">
                      <a class="btn btn-default btn-sm centerBtn" id="survey_motaikuang_return" style="width:20%"><?= Yii::t('common', 'back_button') ?></a>
                    </div>
                  </div>
                </div>
              </div>
         ...
         $(function(){
              ...
              var preview_num_show=1;
			   ...
			   $("#survey_motaikuang_return").click(function(){
		            console.log(pre_new_survey_datas.surveymotaiid);
		            // app.hideAlert("#new_survey_preview_view");
		             app.alertWide("#"+pre_new_survey_datas.surveymotaiid);
		             app.refreshAlert("#"+pre_new_survey_datas.surveymotaiid);
         ...
         function pre_page_fun(id,pid){
             ...
             app.refreshAlert("#new_survey_preview_view");
         }
