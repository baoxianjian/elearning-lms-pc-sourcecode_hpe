...
//        'validateOnSubmit' => true
    ...
    <table class="kv-grid-table table table-bordered table-striped">
        <thead>
            <tr>
                <th colspan="6"><? echo Html::checkbox('checkAllbox',false,['onclick'=>'checkAll(this.checked,"direct_reporter[]");'])?> <?=Yii::t('backend','subordinate_to_choose')?>：</th>
            </tr>
        </thead>
        <tbody>
            <?php
                ...
                foreach ($availableList as $key=>$value)
                {
                    ...
                    echo "<td width='320'>";
                    echo Html::checkbox("direct_reporter[]",$checked,["value"=>$key]);
...
<!--                <td>-->
<!--                    --><?//  echo Html::checkBoxList('direct_reporter[]', $selected_keys, $availableList,['separator'=>'</br>']);?>
<!--                </td>-->
        </tbody>
    </table>
    <?php ActiveForm::end(); ?>
