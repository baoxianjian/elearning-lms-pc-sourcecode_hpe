...
<!--    --><?php //echo $form->errorSummary($model); ?>
    <table width="100%" border="0">
        <tr>
            <td>
                <?= $form->field($model, 'tree_type_code')->textInput(['maxlength' => 30]) ?>
            </td>
            <td>
                <?= $form->field($model, 'tree_type_name')->textInput(['maxlength' => 50]) ?>
            </td>
        </tr>
        <tr>
            <td>
                <?= $form->field($model, 'code_gen_way')->radioList([
                    '0'=>Yii::t('backend', 'code_gen_way_system'),
                    '1'=>Yii::t('backend', 'code_gen_way_manual')],
                    ['separator'=>'&nbsp;&nbsp;']) ?>
            </td>
            <td>
                <?= $form->field($model, 'code_prefix')->textInput(['maxlength' => 30]) ?>
            </td>
        </tr>
        <tr>
            <td>
