...
$this->params['breadcrumbs'][] =  Yii::t('backend',$TreeTypeCode) . Yii::t('backend', 'management');
?>
...
//            alert($('#jsTree_tree').html());
            var ajaxUrl = "<?=Url::toRoute(['tree-node/tree','TreeType'=>$TreeType,'ContentName'=>'tree-node'])?>";
...
TModal::begin([
    'id'=>'addModal',
    'header' => '<h2>'.Yii::t('backend', 'add_{value}',['value'=>Yii::t('backend',$TreeTypeCode)]).'</h2>',
    'footer' =>
...
TModal::begin([
    'id'=>'moveModal',
    'size' => 'modal-sm',
    'header' => '<h2>'.Yii::t('backend', 'move_{value}',['value'=>Yii::t('backend',$TreeTypeCode)]).'</h2>',
    'footer' =>
        Html::button(Yii::t('backend', 'close_button'),
            ['id'=>'closeBtn','class'=>'btn btn-default','data-dismiss'=>'modal'])
        . '' .
        Html::button(Yii::t('backend', 'update'),
            ['id'=>'saveBtn','class'=>'btn btn-primary','onclick'=>'submitModalForm("","clientform-move","moveModal",true,false);'])
]);
?>
...
TModal::begin([
    'id'=>'updateModal',
    'header' => '<h2>'.Yii::t('backend', 'edit_{value}',['value'=>Yii::t('backend',$TreeTypeCode)]).'</h2>',
    'footer' =>
        Html::button(Yii::t('backend', 'close_button'),
            ['id'=>'closeBtn','class'=>'btn btn-default','data-dismiss'=>'modal'])
        . '' .
        Html::button(Yii::t('backend', 'update'),
            ['id'=>'saveBtn','class'=>'btn btn-primary','onclick'=>'UpdateForm();'])
]);
?>
...
TModal::begin([
    'id'=>'viewModal',
    'header' => '<h2>'.Yii::t('backend', 'view_{value}',['value'=>Yii::t('backend',$TreeTypeCode)]).'</h2>',
    'footer' =>
        Html::button(Yii::t('backend', 'close_button'),
            ['id'=>'closeBtn','class'=>'btn btn-default','data-dismiss'=>'modal']),
]);
