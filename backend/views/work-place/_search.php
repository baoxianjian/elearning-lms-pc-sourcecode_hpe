...
<div class="list-search-form">
    ...
    <table  border="0">
        <tr>
            <td>
                <?= $form->field($model, 'dictionary_code')->textInput()->label(Yii::t('backend', '{value}_tree_node_code',['value'=>Yii::t('backend','work_place')])) ?>
            </td>
            <td>
                <?= $form->field($model, 'dictionary_name')->textInput()->label(Yii::t('backend', '{value}_tree_node_name',['value'=>Yii::t('backend','work_place')])) ?>
            </td>
            <td>
